...
class Clients extends MX_Controller {
	...
	public function __construct()
	{
        ...
        public function view(){
            ...
            $this->load->view('templates/dashboard_json',$res);
        }
        ...
        public function clientsgetjson(){
            $res = $this->generic_model->get_data( 'bill_kardex', array('id >'=>'0'), $fields = '', $order_by = null, $rows_num = 0, $group_by = null );
//            
            echo '{"total": 800, "rows":'.json_encode($res).'}';
//            echo '{
//  "total": 800,
//  "rows": [
//    {
